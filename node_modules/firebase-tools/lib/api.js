...
var api = {
    ...
    firestoreOriginOrEmulator: utils.envOverride(Constants.FIRESTORE_EMULATOR_HOST, "https://firestore.googleapis.com", (val) => {
        return `http://${val}`;
    }),
    ...
    realtimeOriginOrEmulator: utils.envOverride(Constants.FIREBASE_DATABASE_EMULATOR_HOST, "https://firebaseio.com", (val) => {
        return `http://${val}`;
    }),
