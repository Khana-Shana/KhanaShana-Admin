    ...
    <Router>
      <div>
        <Switch>
          ...
          <Route path="/adminDB">
            {" "}
            {/* Routes to the Admin Database Screen*/}
            <Header />
            <AdminDB />
          </Route>
          <Route path="/createAccount">
            {" "}
            {/*Routes to the Create Account Screen*/}
            <Header />
            <Signup />
          </Route>
          <Route path="/order">
            {" "}
            {/*Routes to the Order Queue Screen*/}
            <Header />
            <div className="tc">
              <OrderMngNav colr="0" />{" "}
              {/*Order Navbar is called with colr props for conditionally rendering the buttons*/}
              <OrderQ />
            </div>
          </Route>
          <Route path="/completedOrders">
            {" "}
            {/*Routes to the Completed Order Screen*/}
            <Header />
            <div className="tc">
              <OrderMngNav colr="1" />
              <CompletedOrders />
          ...
          <Route path="/history">
            {" "}
            {/*Routes to the Order History Screen*/}
            <Header />
            <div className="tc">
              <OrderMngNav colr="2" />
              <OrderHistory />
          ...
          <Route path="/customerDB">
            {" "}
            {/*Routes to the Customer Database Screen*/}
            <Header />
            <CustomerDB />
          </Route>
          <Route path="/restDetails">
            {" "}
            {/*Routes to the Restaurant Details Screen*/}
            <Header />
            <RestaurantDetails />
          </Route>
          <Route path="/adminProfile">
            {" "}
            {/*Routes to the Profile Screen*/}
            <Header />
            <AdminProfile />
          </Route>
          <Route path="/customerSupport">
            {" "}
            {/*Routes to the Customer Feedback Screen*/}
            <Header />
            <CustomerSupport />
          </Route>
          <Route path="/adminMenu">
            {" "}
            {/*Routes to the Menu Screen*/}
            <Header />
            <AdminMenu />
          </Route>
          <Route path="/login">
          ...
          <Route path="/deals">
            {" "}
            {/*Routes to the Deals Screen*/}
            <Header />
            <AdminDeals />
          </Route>
          <Route path="/wheel">
            {" "}
            {/* Routes to the Wheel Screen*/}
            <Header />
            <DiscountWheel />
          </Route>
          <Route path="/resetpassword">
            {" "}
            {/* Routes to the Reset Password Screen*/}
            <ForgotPassword />
          </Route>
        </Switch>
      </div>
