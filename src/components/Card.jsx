	...
	return (
		<div>
			...
			<div className="grid-layout mt5"> {/* grid-layout css taken from https://stackoverflow.com/questions/8470070/how-to-create-grid-tile-view*/}
				...
				<a type="button" href="/notImplemented" className="item grow span-3" ><h1>Inventory Management</h1></a>
				<a type="button" href="/notImplemented" className="item grow span-3"><h1 >Menu</h1></a>
