      ...
      <form>
        <div className="form-group row">
          ...
          <div className="col-lg-10">
            <button
              type="button"
              className="btn  btn-sm dealbutton"
              onClick={() => removeDeal(props.dealtype)}
            >
              Remove Deal
            </button>
          </div>
        ...
        {menuid === "" ? (
          ...
          <div className="form-group row">
            ...
            <div className="col-lg-10">
              <button type="button" className="btn  btn-sm imgbutton">
                Upload Image
                <input
                  id={props.dealtype + " image"}
                  type="file"
                  onChange={() => uploadDealImage(props.dealtype)}
                  accept="image/png, image/jpeg"
                />
              </button>
              <div className="progress" style={{ marginTop: "2%" }}>
                <div
                  id={props.dealtype + " uploader"}
                  className="progress-bar progress-bar-striped progress-bar-animated"
                  role="progressbar"
                  aria-valuemin="0"
                  aria-valuenow="0"
                  aria-valuemax="100"
                  style={{ width: progressb.toString() + "%" }}
                ></div>
              </div>
            </div>
          </div>
